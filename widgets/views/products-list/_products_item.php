...
<div class="product-card">
    <img src="http://localhost/upload/images/slider/menu/1.jpg" class="card-img-top" alt="...">
    <div class="product-card-body">
        <h5 class="menu-text-size-title"><?=$model->name?></h5>
        <div class="row py-3 row">
            <div class="col-lg-6 card-price <?=($model->on_sale == 0) ? '': 'card-price-on-sale'; ?>">
                <s class="card-price-past"><?=$model->sale?></s>
                <?=$model->cost?>
